...
Cohete::Cohete(Operador *opera)
{
    ...
    //cubo arriba
    misPuntos[8].setValues(0,2,0); //Origen
    misPuntos[9].setValues(1,2,0); //Origen derecha
    misPuntos[10].setValues(0,2,1); //Origen arriba
    misPuntos[11].setValues(1,2,1); //Origen esquina
